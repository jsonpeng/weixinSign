...
{{--     <link rel="stylesheet" href="{{ asset('vendor/bootcss/css/font-awesome.min.css') }}"> --}}
    ...
    <?php $max_week_num = app('zcjy')->maxWeekCoursesNum(); ?>
    .fc-basic-view .fc-body .fc-row {
        min-height: {!! $max_week_num*6 !!}em;
    }
    </style>
    @yield('css')
</head>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                     <?php   $statics = app('zcjy')->staticData();?>
                    <p style="margin-left: 30px;position: absolute;left: 10%; top:15px;color:white;">订单数据:累计订单数量{!! tag($statics->allOrderCount) !!} 累计订单金额{!! tag($statics->allOrderCountPrice) !!} 支付宝订单数量{!! tag($statics->alipayOrderCount) !!} 支付宝订单金额{!! tag($statics->alipayOrderCountPrice)  !!} 微信订单数量{!! tag($statics->wechatOrderCount) !!} 微信订单金额{!! tag($statics->wechatOrderCountPrice)  !!}</p>
